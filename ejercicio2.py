class Pokemon:
    ...
    def __str__(self):
        return f"Pokemon {self.nombre} de tipo {self.tipo} con {self.ps} puntos de salud, {self.ataque} puntos de ataque, {self.defensa} puntos de defensa, {self.ataque_especial} puntos de ataque especial, {self.defensa_especial} puntos de defensa especial y {self.velocidad} puntos de velocidad."